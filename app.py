...
col_graf1, col_graf2 = st.columns(2) #divide em 2 colunas

with col_graf1:
    if not df_filtrado.empty: #10 cargos com maiores salarios médios
        ...
        grafico_cargos.update_layout(title_x=0.1, yaxis={'categoryorder':'total ascending'}) #mover titulo
        st.plotly_chart(grafico_cargos, use_container_width=True) #exibir o grafico
    else:
        st.warning("Nenhum dado para exibir no gráfico de cargos.")

with col_graf2: #2 grafico histograma
    if not df_filtrado.empty:
...
col_graf3, col_graf4 = st.columns(2) #2 linha 

with col_graf3: #grafico de pizza
    if not df_filtrado.empty:
